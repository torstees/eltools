...
'''
usage: mxcovar.py [-h] --vcf VCF [--pop POP] db [db ...]

Process VCF file(s) and build covariance matrices ready for use with MetaXcan

positional arguments:
  db                 One or more MetaXcan DB files to be used locus filtering

optional arguments:
  -h, --help         show this help message and exit
  --vcf VCF          Single VCF file
  --pop POP, -p POP  Text file with IDs to be kept for the final matrices
'''
